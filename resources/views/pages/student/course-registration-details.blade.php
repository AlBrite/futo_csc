    ...
    <div class="scrollerx">
        <div class="hide-on-print px-4 sticky top-10">
            <x-page-header>
                    ...
                    <button ng-click="print()" type="button"
        ...
        <div class="grid place-items-center ">
            <div id="registered-courses-details-container" class="mt-2 border slate-400 rounded p-7 pb-10 md:flex md:flex-col md:gap-2 visible-on-print w-[800px] bg-white">
                ...
                <div class="flex gap-3 items-center mt-8 w-fit mx-auto" id="student-info">
                    ...
                    <div class="flex-1 text-[.78rem] gap-4 text-body-800 items-center whitespace-nowrap md:text-sm print:text-black">
                   
                            <div class="grid grid-cols-4 gap-3">
                                <div class="col-span-1">Full Name:</div>
                                <div class="col-span-1 uppercase font-semibold">{{$user->name}}</div>
                            ...
                            <div class="grid grid-cols-4 gap-3">
                                ...
                                <div class="col-span-1 uppercase font-semibold">{{$session}}</div>
                    ...
                    <table class="mx-auto print:text-black !w-[400px] min-w-[90%]">
                        ...
                        <tbody>
                            ...
                            @foreach($courses as $course)
                                ...
                                <tr>
                                    <td class="!w-[80px]">{{$course->code}}</td>
