    ...
    <div ng-init="init()" ng-controller="StudentController"
        ...
        <div ng-class="{'hidden lg:block': student}"
            ...
            <div class="scroller relative" ng-controller="SearchController">
                    ...
                    <div class="box-body dark:text-white flex flex-col gap-4">
                        <div class="relative">
                            ...
                            <div class="flex justify-between">
                                <div>Admission Year: <span class="text-semibold">{{ $class->start_year }}</span></div>
                                <div>Graduation Year: <span class="text-semibold">{{ $class->end_year }}</span></div>
                            </div>
                        </div>
                        <div class="">
                ...
                <form style="width:100%;position: sticky;top: -20px;background: rgb(100, 100, 100, .5);z-index: 1;" class="flex items-center justify-between gap-2 w-full flex-wrap p-5">

                    <div class="flex-1">
                        <input type="search" ng-model="query" class="input bg-white dark:bg-black !rounded-lg"
                            ng-keyup="search()" placeholder="Enter Student Name or Reg No" ng-keydown="keyDown()" />
                    </div>
                ...
                <div class="student-list" ng-show="query">
                    ...
                    <div ng-show="!typing && results.length > 0" ng-repeat="student in results track by student.id">
